...
from activation_functions import celu, derivatives, relu, sig, softmax, tanh
...
if __name__ == '__main__':
    for test in ['mnist-model']:
        ...
        your_model = FFNN(features=F, hidden_layers=l_h, activation_functions=l_a, classes=C)
